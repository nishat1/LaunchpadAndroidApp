...
public class MainActivity extends AppCompatActivity
    ...
    private void initButtonPressedColorMap() {
        ...
        buttonPressedColorMap.put(0, 0xFF00CCFF);
        buttonPressedColorMap.put(1, 0xFF00CCFF);
        buttonPressedColorMap.put(2, 0xFF00CCFF);
        buttonPressedColorMap.put(3, 0xFF00CCFF);
        buttonPressedColorMap.put(4, 0xFF00CCCC);
        buttonPressedColorMap.put(5, 0xFF00CCCC);
        buttonPressedColorMap.put(6, 0xFF00CCCC);
        buttonPressedColorMap.put(7, 0xFF00CCCC);
        buttonPressedColorMap.put(8, 0xFF00CC99);
        buttonPressedColorMap.put(9, 0xFF00CC99);
        buttonPressedColorMap.put(10, 0xFF00CC99);
        buttonPressedColorMap.put(11, 0xFF00CC99);
        buttonPressedColorMap.put(12, 0xFF00CC66);
        buttonPressedColorMap.put(13, 0xFF00CC66);
        buttonPressedColorMap.put(14, 0xFF00CC66);
        buttonPressedColorMap.put(15, 0xFF00CC66);
        buttonPressedColorMap.put(16, 0xFF00CC00);
    }
